...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('programmes_programme', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='programmes_programme_created_by', null=True, to=orm['auth.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='programmes_programme_modified_by', null=True, to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('summary', self.gf('django.db.models.fields.TextField')()),
            ('spiele', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('programmes', ['Programme'])

        # Adding M2M table for field tags on 'Programme'
        db.create_table('programmes_programme_tags', (
        ...
        db.create_unique('programmes_programme_tags', ['programme_id', 'tag_id'])

        # Adding M2M table for field feature_sets on 'Programme'
        db.create_table('programmes_programme_feature_sets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('programme', models.ForeignKey(orm['programmes.programme'], null=False)),
            ('featureset', models.ForeignKey(orm['features.featureset'], null=False))
        ))
        db.create_unique('programmes_programme_feature_sets', ['programme_id', 'featureset_id'])

        # Adding model 'ProgrammeImage'
        db.create_table('programmes_programmeimage', (
            ('image_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['images.Image'], unique=True, primary_key=True)),
            ('programme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['programmes.Programme'])),
        ))
        db.send_create_signal('programmes', ['ProgrammeImage'])


    def backwards(self, orm):
        
        # Deleting model 'Programme'
        db.delete_table('programmes_programme')

        # Removing M2M table for field tags on 'Programme'
        db.delete_table('programmes_programme_tags')

        # Removing M2M table for field feature_sets on 'Programme'
        db.delete_table('programmes_programme_feature_sets')

        # Deleting model 'ProgrammeImage'
        db.delete_table('programmes_programmeimage')
