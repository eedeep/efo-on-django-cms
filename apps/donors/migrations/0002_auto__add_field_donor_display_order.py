...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Donor.display_order'
        db.add_column('donors_donor', 'display_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donor.display_order'
        db.delete_column('donors_donor', 'display_order')
