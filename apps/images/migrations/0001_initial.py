...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('images_image', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='images_image_created_by', null=True, to=orm['auth.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='images_image_modified_by', null=True, to=orm['auth.User'])),
